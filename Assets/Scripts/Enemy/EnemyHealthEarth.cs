...
public class EnemyHealthEarth : MonoBehaviour {
	...
	void Start () {
		...
		enemyAttack = GetComponentInChildren<EnemyAttackEarth> ();
	...
	void Death (){
		...
		AchievementManager.AM.AchievementIncreaseAmount("Tierra",1);
